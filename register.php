        ...
        if(isset($_POST["captcha"]) && !empty($captcha)){
            ...
            if(isset($_POST["login"])){
                ...
                if(!empty($login)){
                    ...
                    $result_query = $mysqli->query("SELECT 'Login' FROM $MySQL_table_Users WHERE Login = '$login'");
            ...
            if(isset($_POST["email"])){
                ...
                if(!empty($email)){
                    ...
                    //Проверяем нет ли уже такого адреса в БД.
                    $result_query = $mysqli->query("SELECT 'email' FROM $MySQL_table_Users WHERE Email = '$email'");
            ...
            $result_query_insert = $mysqli->query("INSERT INTO $MySQL_table_Users (Login, Name, Email, Pass) VALUES ('$login', '$first_name $last_name', '$email', '$password')");
